...
As the optimization is fully determenistic, the script should produce exactly the same results as in *test_data_output.out* regardless of your PC configurations.
